...
export const CallNumberField = ({name, value, readOnly}) => (<div className="call-number">
  <FormGroup className="col-sm-2 no-pad-left" name={name + '_' + CallNumber.PREFIX} label={getLabel("LABEL_PREFIX")}>
  ...
  <FormGroup className="col-sm-5 " name={name + '_' + CallNumber.MAIN} label={getLabel("LABEL_MAIN")}>
  ...
  <FormGroup className="col-sm-2 " name={name + '_' + CallNumber.CUTTER} label={getLabel("LABEL_CUTTER")}>
  ...
  <FormGroup className="col-sm-3 " name={name + '_' + CallNumber.SUFFIX} label={getLabel("LABEL_SUFFIX")}>
